        ...
        stage('Deploy') {
            steps {
                sshagent(credentials: ['ACIT-3855-keys']) {
                    sh 'ssh -o StrictHostKeyChecking=no -l azureuser acit-3855.eastus.cloudapp.azure.com docker-compose -f docker pull jovan9876/reciever:latest;docker pull jovan9876/storage:latest;docker pull jovan9876/processing:latest;docker pull jovan9876/audit_log:latest;ACIT3855/deployment/docker-compose.yml up -d'
                }
            }   
        }
    }
